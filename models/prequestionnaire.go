...
func (p *Prequestionnaire) Validate(tx *pop.Connection) (*validate.Errors, error) {
	...
	log.Printf("TEST %v", p.HasDesignedVideoGame)
	return validate.Validate(
		...
		&validators.StringIsPresent{Field: p.MostImportantVideoGameAspects, Name: "MostImportantVideoGameAspects", Message: "Please select one or more values here"},
