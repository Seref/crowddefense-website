...
CREATE TABLE `suggestions` (
  ...
  `version_when_suggested` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `upvoted_by` json NOT NULL,
  `downvoted_by` json NOT NULL,
  `editable` tinyint(1) NOT NULL,
  `keywords` json NOT NULL,
  `fulfilled` tinyint(1) NOT NULL,
  `suggested_by` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
-- Dump completed on 2019-12-01 20:28:04
